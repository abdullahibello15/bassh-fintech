...
import { ArrowRight, Shield, TrendingUp, CreditCard, Clock, Globe, Users, Lock, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0e1a] via-[#0f1420] to-[#0a0e1a]">
      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-xl bg-[#0a0e1a]/80 border-b border-[#c9a84c]/20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-heading font-semibold" style={{ fontSize: '24px', color: '#c9a84c' }}>
              Fintech
            </span>
          </div>
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h1 className="font-heading mb-6" style={{ fontSize: '64px', lineHeight: '1.1', color: '#ffffff' }}>
              Banking for the
              <span className="block bg-gradient-to-r from-[#c9a84c] to-[#3b82f6] bg-clip-text text-transparent">
                Digital Age
              </span>
            </h1>
            <p className="mb-10 mx-auto max-w-2xl" style={{ fontSize: '20px', color: 'rgba(255, 255, 255, 0.7)' }}>
              Experience premium digital banking with cutting-edge security, instant transactions, and personalized financial insights.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Track your spending, investments, and financial goals with intelligent insights.',
              },
              {
                icon: Clock,
                title: 'Instant Transfers',
                description: 'Send and receive money instantly with zero fees to other platform users.',
              },
              {
                icon: Globe,
                title: 'Global Access',
                description: 'Manage your finances from anywhere with our mobile-first platform.',
              },
              {
                icon: CreditCard,
                title: 'Virtual Cards',
              ...
              >
                ...
                <h3 className="font-heading mb-3" style={{ fontSize: '24px', color: '#ffffff' }}>
                  {feature.title}
                </h3>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-20 px-6 bg-gradient-to-br from-[#141e32]/40 to-transparent">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-heading mb-4" style={{ fontSize: '48px', color: '#ffffff' }}>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: '01', title: 'Create Account', description: 'Sign up with your email in under 2 minutes' },
              { step: '02', title: 'Verify Identity', description: 'Quick and secure identity verification' },
              { step: '03', title: 'Fund Account', description: 'Add funds via bank transfer or card' },
              { step: '04', title: 'Start Banking', description: 'Enjoy full access to all features' },
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section id="security" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-heading mb-6" style={{ fontSize: '48px', color: '#ffffff' }}>
                Your Security is Our Priority
              </h2>
              <p className="mb-8" style={{ fontSize: '18px', color: 'rgba(255, 255, 255, 0.7)' }}>
                We employ the latest security technologies to ensure your funds and data are always protected.
              </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 rounded-2xl bg-gradient-to-br from-[#c9a84c]/20 to-[#3b82f6]/20 backdrop-blur-xl border border-[#c9a84c]/40">
            ...
            <p className="mb-8" style={{ fontSize: '20px', color: 'rgba(255, 255, 255, 0.7)' }}>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-heading" style={{ fontSize: '20px', color: '#c9a84c' }}>
                  Fintech
                </span>
              </div>
            ...
            <div>
              <h4 className="font-heading mb-4" style={{ color: '#ffffff' }}>Product</h4>
              <div className="space-y-2">
                <div><a href="#" className="text-white/60 hover:text-[#c9a84c] transition-colors">Features</a></div>
                <div><a href="#" className="text-white/60 hover:text-[#c9a84c] transition-colors">Pricing</a></div>
                <div><a href="#" className="text-white/60 hover:text-[#c9a84c] transition-colors">Security</a></div>
              </div>
            </div>
            <div>
              <h4 className="font-heading mb-4" style={{ color: '#ffffff' }}>Company</h4>
              <div className="space-y-2">
                <div><a href="#" className="text-white/60 hover:text-[#c9a84c] transition-colors">About</a></div>
                <div><a href="#" className="text-white/60 hover:text-[#c9a84c] transition-colors">Careers</a></div>
                <div><a href="#" className="text-white/60 hover:text-[#c9a84c] transition-colors">Contact</a></div>
              </div>
            </div>
            <div>
              <h4 className="font-heading mb-4" style={{ color: '#ffffff' }}>Legal</h4>
              <div className="space-y-2">
                <div><a href="#" className="text-white/60 hover:text-[#c9a84c] transition-colors">Privacy</a></div>
                <div><a href="#" className="text-white/60 hover:text-[#c9a84c] transition-colors">Terms</a></div>
                <div><a href="#" className="text-white/60 hover:text-[#c9a84c] transition-colors">Compliance</a></div>
              </div>
            </div>
          </div>
          <div className="pt-8 border-t border-[#c9a84c]/20 text-center" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>
